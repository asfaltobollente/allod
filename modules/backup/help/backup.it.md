...
1. **Uso esclusivo su Rete Mesh Privata**: Esponi la porta 8000 solo sull'overlay WireGuard o Headscale (`100.64.0.0/10` / `10.42.0.0/16`). Non effettuare port forwarding della porta 8000 sul router di casa.
