...
const i18n = {
  en: {
    ...
    wol_btn_save_changes: "Save Changes",
    ...
    watch_step1_params_title: "Step 1: Network & Authentication Settings",
    ...
    watch_step2_deploy_title: "Step 2: Deploy Sentinel (SSH)",
    watch_env_root_btn: "🐧 Linux VPS (Root / Sudo)",
    watch_env_rootless_btn: "☁️ Alwaysdata / PaaS (Rootless)",
    watch_env_rootless_title: "☁️ Alwaysdata / PaaS Setup (No root or sudo required):",
    watch_env_rootless_step1: "1. Connect via SSH to your Alwaysdata account (e.g. <code>ssh -l USER ssh-USER.alwaysdata.net</code>).",
    watch_env_rootless_step2: "2. Paste the command below: downloads the binary to <code>~/bin/allod-watch</code> and writes config to <code>~/.config/allod/watch.yaml</code>.",
    watch_env_rootless_step3: "3. In the Alwaysdata dashboard (<b>Web &gt; Sites</b>): create/edit a site of type <b>User program</b> with command:",
    watch_env_rootless_note: "💡 Alwaysdata routes public HTTPS (port 443) directly to the user program using the $IP and $PORT environment variables.",
    watch_step3_verify_title: "Step 3: Verify VPS Connection (After starting VPS)",
    watch_step3_verify_desc: "After running the command on your VPS, click below to send a test heartbeat and verify communication:",
    ...
    watch_btn_copy_cmd: "Copy Command for VPS",
    watch_btn_copy_cmd_rootless: "Copy Command for Alwaysdata / PaaS",
  ...
  it: {
    ...
    wol_btn_save_changes: "Salva Modifiche",
    ...
    watch_step1_params_title: "Passo 1: Parametri di Rete & Autenticazione",
    ...
    watch_step2_deploy_title: "Passo 2: Installa la Sentinella (SSH)",
    watch_env_root_btn: "🐧 VPS Linux (Root / Sudo)",
    watch_env_rootless_btn: "☁️ Alwaysdata / PaaS (Senza Root)",
    watch_env_rootless_title: "☁️ Installazione Alwaysdata / PaaS (Nessun permesso root o sudo necessario):",
    watch_env_rootless_step1: "1. Connettiti via SSH al tuo account Alwaysdata (es. <code>ssh -l UTENTE ssh-UTENTE.alwaysdata.net</code>).",
    watch_env_rootless_step2: "2. Incolla il comando qui sotto: scarica il binario in <code>~/bin/allod-watch</code> e scrive la configurazione in <code>~/.config/allod/watch.yaml</code>.",
    watch_env_rootless_step3: "3. Nel pannello Alwaysdata (<b>Web &gt; Siti</b>): crea/modifica un sito di tipo <b>Programma utente</b> con comando:",
    watch_env_rootless_note: "💡 Alwaysdata instrada il traffico HTTPS pubblico (porta 443) direttamente al programma utente tramite le variabili d'ambiente $IP e $PORT.",
    watch_step3_verify_title: "Passo 3: Verifica Connessione (Dopo aver avviato la VPS)",
    watch_step3_verify_desc: "Dopo aver eseguito il comando sulla VPS, clicca qui sotto per inviare un heartbeat di prova e verificare la comunicazione:",
    ...
    watch_btn_copy_cmd: "Copia Comando per VPS",
    watch_btn_copy_cmd_rootless: "Copia Comando per Alwaysdata / PaaS",
    watch_vps_instructions_title: "Come installare sulla VPS in 10 secondi:",
    watch_vps_step1: "1. Connettiti via SSH alla tua VPS esterna: <code>ssh root@ip-vps</code> (oppure utente con sudo).",
    watch_vps_step2: "2. Incolla il comando copiato qui sopra e premi <b>Invio</b>.",
